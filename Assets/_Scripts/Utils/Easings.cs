...
static public class Easings {
    ...
    /// <summary>
    /// This is used to store interpolation function for direct look-up, better than using switch :)
    /// </summary>
    private delegate float InterpolationFunction(float p);
    private static Dictionary<Functions, InterpolationFunction> dictInterpolationFunctions = new Dictionary<Functions, InterpolationFunction>(){
        { Functions.Linear,                 Linear },
        { Functions.QuadraticEaseOut,       QuadraticEaseOut    },
        { Functions.QuadraticEaseIn,        QuadraticEaseIn     },
        { Functions.QuadraticEaseInOut,     QuadraticEaseInOut  },
        { Functions.CubicEaseIn,            CubicEaseIn         },
        { Functions.CubicEaseOut,           CubicEaseOut        },
        { Functions.CubicEaseInOut,         CubicEaseInOut      },
        { Functions.QuarticEaseIn,          QuarticEaseIn       },
        { Functions.QuarticEaseOut,         QuarticEaseOut      },
        { Functions.QuarticEaseInOut,       QuarticEaseInOut    },
        { Functions.QuinticEaseIn,          QuinticEaseIn       },
        { Functions.QuinticEaseOut,         QuinticEaseOut      },
        { Functions.QuinticEaseInOut,       QuinticEaseInOut    },
        { Functions.SineEaseIn,             SineEaseIn          },
        { Functions.SineEaseOut,            SineEaseOut         },
        { Functions.SineEaseInOut,          SineEaseInOut       },
        { Functions.CircularEaseIn,         CircularEaseIn      },
        { Functions.CircularEaseOut,        CircularEaseOut     },
        { Functions.CircularEaseInOut,      CircularEaseInOut   },
        { Functions.ExponentialEaseIn,      ExponentialEaseIn   },
        { Functions.ExponentialEaseOut,     ExponentialEaseOut  },
        { Functions.ExponentialEaseInOut,   ExponentialEaseInOut},
        { Functions.ElasticEaseIn,          ElasticEaseIn       },
        { Functions.ElasticEaseOut,         ElasticEaseOut      },
        { Functions.ElasticEaseInOut,       ElasticEaseInOut    },
        { Functions.BackEaseIn,             BackEaseIn          },
        { Functions.BackEaseOut,            BackEaseOut         },
        { Functions.BackEaseInOut,          BackEaseInOut       },
        { Functions.BounceEaseIn,           BounceEaseIn        },
        { Functions.BounceEaseOut,          BounceEaseOut       },
        { Functions.BounceEaseInOut,        BounceEaseInOut     },
    };

    /// <summary>
    /// Interpolate using the specified function.
    /// </summary>
    static public float Interpolate(float alpha, Functions function = Functions.Linear) {
        return dictInterpolationFunctions[function](alpha);
        /*switch (function) {
            default:
    ...
    static public float SineEaseIn(float p) {
        return Math.Sin((p - 1.0f) * HALFPI) + 1.0f;
    }
    ...
    static public float SineEaseInOut(float p) {
        return 0.5f * (1.0f - Math.Cos(p * PI));
    }
    ...
    static public float ExponentialEaseIn(float p) {
        return (p == 0.0f) ? p : Math.Pow(2.0f, 10.0f * (p - 1.0f));
    }
    ...
    static public float ExponentialEaseOut(float p) {
        return (p == 1.0f) ? p : 1.0f - Math.Pow(2.0f, -10.0f * p);
    }
    ...
    static public float ExponentialEaseInOut(float p) {
        ...
        if (p < 0.5f) {
            return 0.5f * Math.Pow(2.0f, (20.0f * p) - 10.0f);
        } else {
            return -0.5f * Math.Pow(2.0f, (-20.0f * p) + 10.0f) + 1.0f;
        }
    }
    ...
    static public float BackEaseOut(float p) {
        float f = (1.0f - p);
        return 1.0f - (f * f * f - f * Math.Sin(f * PI));
    }
    ...
    static public float BackEaseInOut(float p) {
        if (p < 0.5f) {
            ...
            return 0.5f * (1.0f - (f * f * f - f * Math.Sin(f * PI))) + 0.5f;
        }
    }
